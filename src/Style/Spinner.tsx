...
border-top-color: ${({theme, colour})=> colour ? theme.colours[colour] : '#09f' } ;
...
&:after {
  ...
  border:solid 2px transparent;
  border-radius:50%;
  border-right-color: ${({theme, colour})=> colour ? theme.colours[colour] : '#6ff' } ;
  border-top-color: ${({theme, colour})=> colour ? theme.colours[colour] : '#6ff' } ;
  box-sizing:border-box;
  content:"";
  height:12px;
  left:2px;
