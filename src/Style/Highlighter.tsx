...
// border-right: solid 1px transparent;
    ...
    background: linear-gradient(to right, ${({ theme }) => theme.colours.platinum} 20%,
    ${({ theme }) => theme.colours.platinum} 40%,
    ${({ theme }) => theme.colours.mountainMeadow} 50%, ${({ theme }) => theme.colours.mountainMeadow} 55%,
     ${({ theme }) => theme.colours.platinum} 70%,
     ${({ theme }) => theme.colours.platinum} 100%);
    background: -moz-linear-gradient(309deg, rgba(5,102,141,1) 20%,
    rgba(5,102,141,1) 40%,
    rgba(2,128,144,1) 50%, rgba(2,128,144,1) 55%,
     rgba(2,195,154,1) 70%,
